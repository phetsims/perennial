...
`cd perennial; grunt sync-codebase --allBranches` to pull all repos and release branches. Then:
...
One way to do this in perennial is `cd perennial; grunt sync-codebase --allBranches`. Otherwise the next step will
