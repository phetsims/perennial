...
export default {
  ...
  // sim build request keys
  API_KEY: 'api' as const,
  ...
  BRANDS_KEY: 'brands' as const,
  // optional
  EMAIL_KEY: 'email' as const,
  USER_ID_KEY: 'userId' as const,
  DEPLOY_IMAGES_KEY: 'deployImages' as const,
